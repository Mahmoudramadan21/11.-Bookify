...
export const userLogin = (formData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post(
            "https://bookify.pythonanywhere.com/api/users/login/",
            formData,
            config
        );
...
export const userRegister = (formData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post("https://bookify.pythonanywhere.com/api/users/register/",
            formData,
            config
        )
...
export const updateUserProfile = (formData) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.put(
            "https://bookify.pythonanywhere.com/api/users/profile/update/",
            formData,
            config
        )
...
export const getUserDetails = (id) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.get(
            `https://bookify.pythonanywhere.com/api/users/${id}/`,
            config
        )
...
export const listUsers = () => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.get(
            `https://bookify.pythonanywhere.com/api/users/`,
            config
        )
...
export const deleteUser = (id) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.delete(
            `https://bookify.pythonanywhere.com/api/users/delete/${id}/`,
            config
        )
...
export const updateUser = (user) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.put(
            `https://bookify.pythonanywhere.com/api/users/update/${user.id}/`,
            user,
            config
        )
